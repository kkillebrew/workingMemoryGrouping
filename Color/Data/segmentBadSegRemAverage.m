...
fileListRawdata = {'K002_wmGrouping_110714_001_full','K003_wmGrouping_111114_001_full','MC_wmGrouping_111114_002_full','ZZ_wmGrouping_111114_002_full',...
    'KM_wmGrouping_111214_002_full','KK_wmGrouping_111214_001_full','K004_wmGrouping_111314_001_full','NS_wmGrouping_111314_001_full',...
...
fileListEEGdata = {'K002_20141107_032841_fil_seg_bcr','K003_20141111_110256_fil_seg_bcr','MC_20141111_124003_fil_seg_bcr',...
    'ZZ_20141111_025735_fil_seg_bcr','KM_20141112_040211_fil_seg_bcr','KK_20141112_051846_fil_seg_bcr','K004_20141113_100301_fil_seg_bcr',...
...
fileListBadSeg = {'K002_20141107_032841_fil_seg_bcr.txt','K003_20141111_110256_fil_seg_bcr.txt','MC_20141111_124003_fil_seg_bcr.txt',...
    'ZZ_20141111_025735_fil_seg_bcr.txt','KM_20141112_040211_fil_seg_bcr.txt','KK_20141112_051846_fil_seg_bcr.txt','K004_20141113_100301_fil_seg_bcr.txt',...
...
subjID = {'K002','K003','MC','ZZ','KM','KK','K004','NS','K005','MG','CB','CC','SR','CR','TL','K006','AW','MM','GG','K007','K008','K009','K010'};
...
for a=length(fileListRawdata)'
    ...
    if badSegNumber >= .25*(length(badSegments{1}))
        save(sprintf('%s%s%s%s',inputFile,subjID{a},'/badSeg_',subjID{a}),'badSegments','badSegNumber');
    else
        ...
        for p=1:length(conditionList)
            ...
            save(sprintf('%s%s%s%s',inputFile,subjID{a},'/',conditionList{p}),conditionList{p})
        end
