...
for a=1:length(fileListRawdata)'
    ...
    load(sprintf('%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/',fileListRawdata{a}),'rateraw','rawdata');
    load(sprintf('%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/',fileListEEGdata{a}));
    ...
    fileID=fopen(sprintf('%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/',fileListBadSeg{a}));
    formatSpec='%*s %*s %*s %s %*[^\n]';
...
%         save(sprintf('%s%s%s%s',inputFile,subjID{a},'/Updated/badSeg_',subjID{a}),'badSegments','badSegNumber');
        save(sprintf('%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/badSeg_',subjID{a}),'badSegments','badSegNumber');
    else
...
p
            save(sprintf('%s%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/',conditionList{p}),conditionList{p})
        end
...
%     save(sprintf('%s%s%s%s%s%s',inputFile,subjID{a},'/Updated/badSeg_',subjID{a}),'badSegments','badSegNumber');
    save(sprintf('%s%s%s%s%s%s',inputFile,subjID{a},'/VEP Data/Baseline_Correct/badSeg_',subjID{a}),'badSegments','badSegNumber');
    
    
end

% save(sprintf('%s%s',inputFile,'/usableParticipants'),'usableParticipants');
save(sprintf('%s%s',inputFile,'/usableParticipants_VEP_BLC'),'usableParticipants');
